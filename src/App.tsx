    ...
    events: [
      {
        ...
        details: 'Okkur verður skutlað frá hótelinu í Stafrænt Finnland',
      ...
      },
      {
        ...
        details: 'Okkur verður skutlað frá DVV til þingsins og síðan aftur á hótelið.',
